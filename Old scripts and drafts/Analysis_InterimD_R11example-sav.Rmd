---
title: "Example Report ESS R11 based on a dummy dataset. Note that the content of the results are based on randomly generated numbers" 
  output:
  pdf_document:
    includes:
...
```{r dummydataset, error=T}
#Notes and solutions for dummy Dataset

#Dummy dataset has multiple countries
table(Main$cntry, useNA = "always")
#Solution: single country for Dummy dataset
Main$cntry <- "NL"

#Intnum for all cases
table(Main$intnum, useNA = "always")
#Solution: Assigned random intnum 1-5
Main$intnum <- floor(runif(53, min=1, max=11))

...
Main$fulldate <- as_datetime(Main$inwds, origin = "1899-12-30") #Alert! Change origin to match the source system default 
# fulldatetime for start and end of interview
Main$start <- as_datetime(Main$inwds, origin = "1899-12-30")
Main$end <- as_datetime(Main$inwde, origin = "1899-12-30")
# fulldatetime for modules
Main$end_a <- as_datetime(Main$ainwe, origin = "1899-12-30")
Main$end_b <- as_datetime(Main$binwe, origin = "1899-12-30")
Main$end_c <- as_datetime(Main$cinwe, origin = "1899-12-30")
Main$end_d <- as_datetime(Main$dinwe, origin = "1899-12-30")
Main$end_f <- as_datetime(Main$finwe, origin = "1899-12-30")
Main$end_g <- as_datetime(Main$ginwe, origin = "1899-12-30")
Main$end_h <- as_datetime(Main$hinwe, origin = "1899-12-30")
Main$end_i <- as_datetime(Main$iinwe, origin = "1899-12-30") 
